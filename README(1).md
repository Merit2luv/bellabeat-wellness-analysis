...
## Dashboard
An interactive Tableau dashboard visualizing these findings is available here: **[link to be added]**

## Author
Analysis conducted by Weezy, as a self-directed portfolio project extending the Google Data Analytics Certificate capstone case study (Bellabeat), using a local Python/DuckDB environment in place of cloud-based tools.
